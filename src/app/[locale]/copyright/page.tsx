...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Desktop Explorer Wiki',
    description: 'Copyright and intellectual property information for Desktop Explorer Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Desktop Explorer Wiki',
      description: 'Copyright and intellectual property information for Desktop Explorer Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Desktop Explorer Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Desktop Explorer Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Desktop Explorer Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Steam</strong> - Owner of the Steam platform</li>
              <li><strong>Desktop Explorer Developers</strong> - Creators of the Desktop Explorer game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Desktop Explorer</strong> - Trademark of the game developers</li>
              <li><strong>Desktop Explorer Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Desktop Explorer Wiki.
            </p>
            ...
            <p>
              ...
              Desktop Explorer Wiki<br />
              Email: <a href="mailto:dmca@desktop-explorer.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@desktop-explorer.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Desktop Explorer Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Desktop Explorer Wiki (desktop-explorer.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@desktop-explorer.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@desktop-explorer.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@desktop-explorer.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@desktop-explorer.wiki</a>
            </p>
            <p>
