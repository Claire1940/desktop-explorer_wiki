...
export default function HomePageClient({
  ...
  const siteUrl =
    process.env.NEXT_PUBLIC_SITE_URL || "https://desktop-explorer.wiki";
    ...
    "@graph": [
      {
        ...
        "@id": `${siteUrl}/#website`,
        url: siteUrl,
        name: "Desktop Explorer Wiki",
        description:
          "Complete Desktop Explorer Wiki covering walkthroughs, puzzle solutions, hidden files, endings, secrets, and mystery guides for the retro 90s PC horror adventure on Steam.",
        image: {
          "@type": "ImageObject",
          url: `${siteUrl}/images/hero.webp`,
          width: 1920,
          height: 620,
          caption: "Desktop Explorer - Retro PC Horror Mystery",
        },
        potentialAction: {
          "@type": "SearchAction",
      ...
      },
      {
        ...
        name: "Desktop Explorer Wiki",
        alternateName: "Desktop Explorer",
        url: siteUrl,
        description:
          "Complete Desktop Explorer Wiki resource hub for walkthroughs, puzzles, hidden files, endings, secrets, and mystery guides",
        logo: {
          "@type": "ImageObject",
        ...
        image: {
          ...
          width: 1920,
          height: 620,
          caption: "Desktop Explorer Wiki - Retro PC Horror Mystery",
        },
        sameAs: [
      ...
      },
      {
        ...
        genre: ["Adventure", "Indie", "Simulation", "Mystery", "Horror"],
        numberOfPlayers: {
          minValue: 1,
          maxValue: 1,
        },
        offers: {
          ...
          url: "https://store.steampowered.com/app/2527160/Desktop_Explorer/",
        },
      },
      {
        "@type": "VideoObject",
        name: "Desktop Explorer - Official Release Date Trailer",
        description:
          "Official Desktop Explorer release date trailer showcasing the retro 90s PC horror mystery adventure.",
        uploadDate: "2026-06-04",
        thumbnailUrl: `${siteUrl}/images/hero.webp`,
        embedUrl: "https://www.youtube.com/embed/oc4qS3v1f8s",
        url: "https://www.youtube.com/watch?v=oc4qS3v1f8s",
      },
    ],
  };
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-8 scroll-reveal">
            ...
            <div className="mb-10 flex flex-col justify-center gap-3 sm:flex-row md:mb-12 md:gap-4">
              ...
              <a
                href="https://store.steampowered.com/app/2527160/Desktop_Explorer/"
                target="_blank"
      ...
      <section className="px-4 py-10 md:py-12">
        <div className="scroll-reveal container mx-auto max-w-6xl">
          <div className="relative overflow-hidden rounded-2xl">
            <VideoFeature
              videoId="oc4qS3v1f8s"
              title="Desktop Explorer - Official Release Date Trailer"
            />
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <a
                    href="https://steamcommunity.com/app/2527160"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-muted-foreground hover:text-[hsl(var(--nav-theme-light))] transition"
                  >
